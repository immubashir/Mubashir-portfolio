...
function CenterNode({
  ...
  return (
    ...
    >
      <motion.div
        className="absolute left-1/2 top-1/2 rounded-full border border-neutral-900 bg-black "
        initial={false}
        animate={{
...
function MainNodeDot({
  ...
  onClick: () => void;
    ...
    design:
        "radial-gradient(circle, rgba(168,85,247,0.32) 0%, rgba(168,85,247,0.16) 38%, rgba(168,85,247,0.00) 72%)",
    frontend:
        "radial-gradient(circle, rgba(59,130,246,0.28) 0%, rgba(59,130,246,0.14) 38%, rgba(59,130,246,0.00) 72%)",
    ml: "radial-gradient(circle, rgba(236,72,153,0.28) 0%, rgba(236,72,153,0.14) 38%, rgba(236,72,153,0.00) 72%)",
    research:
        "radial-gradient(circle, rgba(245,158,11,0.24) 0%, rgba(245,158,11,0.12) 38%, rgba(245,158,11,0.00) 72%)",
    systems:
        "radial-gradient(circle, rgba(16,185,129,0.26) 0%, rgba(16,185,129,0.13) 38%, rgba(16,185,129,0.00) 72%)",
    product:
        "radial-gradient(circle, rgba(249,115,22,0.28) 0%, rgba(249,115,22,0.14) 38%, rgba(249,115,22,0.00) 72%)",
    };
  ...
  return (
    ...
    >
      <motion.div
        ...
        initial={false}
        animate={{
          opacity: visible ? (dimmed ? 0.12 : active ? 1 : 0.78) : 0,
          scale: active ? 1.14 : visible ? 1 : 0.72,
        }}
        transition={
          visible
            ? {
      ...
      <motion.div
        className={`absolute left-1/2 top-[20px] -translate-x-1/2 whitespace-nowrap text-sm tracking-wide ${
  ...
  return (
    <section className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-white px-6 py-20 text-black">
      <motion.div
        ...
        className="relative h-[680px] w-full max-w-[980px] overflow-visible rounded-[2rem]"
      >
